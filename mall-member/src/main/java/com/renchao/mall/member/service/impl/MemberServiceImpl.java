...
import com.renchao.mall.member.entity.MemberReceiveAddressEntity;
import com.renchao.mall.member.service.MemberLevelService;
import com.renchao.mall.member.service.MemberReceiveAddressService;
...
import com.renchao.mall.member.dao.MemberDao;
...
public class MemberServiceImpl extends ServiceImpl<MemberDao, MemberEntity> implements MemberService {
    ...
    public void checkPhoneUnique(String phone) {
        ...
        if (count > 0) {
            throw new MallRegisterException("手机已被使用！");
        }
    }
    ...
    public void checkUsernameUnique(String username) {
        ...
        int count = this.count(wrapper);
        if (count > 0) {
            throw new MallRegisterException("用户名已存在！");
        }
    }
